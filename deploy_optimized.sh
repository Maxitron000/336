...
def cleanup_old_data():
    ...
    if os.path.exists('data/personnel.db'):
        ...
        # 🗑️ Удаляем записи старше 6 месяцев
...
echo "2. 📁 Скопируйте файлы: main_optimized.py, setup_optimized.py"
echo "3. 🚀 Запустите: python3.10 setup_optimized.py"
echo "4. 📋 Создайте Always On Task в панели PythonAnywhere"
echo "5. ⚡ Команда для задачи: python3.10 /home/yourusername/telegram_bot/main_optimized.py"
echo ""
...
echo ""
echo "📖 Подробности в файле: DEPLOY_GUIDE.md"
echo "🎯 Чек-лист функций: BOT_CHECKLIST.md"