# 🚀 Установка бота на PythonAnywhere Free (aiogram)
...
3. Заполните форму:
   - **Command**: `cd ~/telegram_bot && source venv/bin/activate && python3.10 main.py`
   - **Schedule**: Daily
   - **Time**: 00:00
...
1. **Используйте Daily Task** вместо Always-on для экономии ресурсов
2. **Установите `LOG_LEVEL=WARNING`** в .env для экономии ресурсов
3. **Периодически очищайте логи** - добавьте задачу очистки
4. **Используйте только необходимые зависимости**
